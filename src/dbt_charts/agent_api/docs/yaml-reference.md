...
| `queries` | dict[str, [SqlQuery](#sqlquery) \| [MetricflowQuery](#metricflowquery) \| [HttpQuery](#httpquery) \| [ValuesQuery](#valuesquery) \| [CompactValuesQuery](#compactvaluesquery) \| [SchemaQuery](#schemaquery) \| QueryRef] | ✓ | Named query definitions (SQL, CSV, MetricFlow, HTTP, etc.). |
...
| `style` | [Style](#style) | ✓ | Style patch (background, padding, border, etc.). Background and semantic color tokens (accent, muted) cascade to nested child boards. |
...
| `query` | str \| [SqlQuery](#sqlquery) \| [MetricflowQuery](#metricflowquery) \| [HttpQuery](#httpquery) \| [ValuesQuery](#valuesquery) \| [CompactValuesQuery](#compactvaluesquery) \| [SchemaQuery](#schemaquery) | ✓ | Query name or inline query definition for populating options. |
...
| `query` | str \| [SqlQuery](#sqlquery) \| [MetricflowQuery](#metricflowquery) \| [HttpQuery](#httpquery) \| [ValuesQuery](#valuesquery) \| [CompactValuesQuery](#compactvaluesquery) \| [SchemaQuery](#schemaquery) \| QueryRef | ✓ | Named query reference, inline AuthoredQuery, or SQL string shorthand. |
...
| `sort` | [ChartSort](#chartsort) | ✓ | Sort configuration: column to sort by and direction (asc/desc). |
...
| `layers` | list[[BarLayer](#barlayer) \| [LineLayer](#linelayer) \| [AreaLayer](#arealayer) \| [ScatterLayer](#scatterlayer)] | ✓ | Typed overlay layers on this chart. |
...
| `title` | [TitleStyle](#titlestyle) | ✓ | Board and board title style. |
...
| `style` | [BarLayerStyle](#barlayerstyle) | ✓ | Bar layer mark style overrides. |
...
| `color` | str | ✓ | Color data channel for this layer: bare column name only. |
| `axis_y` | [LayerAxisYStyle](#layeraxisystyle) | ✓ | Y-axis settings for this layer (orientation, title). |
| `style` | [LineLayerStyle](#linelayerstyle) | ✓ | Line layer mark style overrides. |
...
| `color` | str | ✓ | Color data channel for this layer: bare column name only. |
| `axis_y` | [LayerAxisYStyle](#layeraxisystyle) | ✓ | Y-axis settings for this layer (orientation, title). |
| `style` | [AreaLayerStyle](#arealayerstyle) | ✓ | Area layer mark style overrides. |
...
| `color` | str | ✓ | Color data channel for this layer: bare column name only. |
| `axis_y` | [LayerAxisYStyle](#layeraxisystyle) | ✓ | Y-axis settings for this layer (orientation, title). |
| `style` | [ScatterLayerStyle](#scatterlayerstyle) | ✓ | Scatter layer mark style overrides. |
...
| `format` | str \| [FormatConfig](#formatconfig) \| enum: "compact", "currency", "currency_compact", "currency_whole", "date_short", "delta", "integer", "number", "number_default", "percent", "percent_delta", "percent_whole", "year" | ✓ | Number format (D3 spec, preset, or FormatConfig). |
...
| `tones` | [KpiTonesStyle](#kpitonesstyle) | ✓ | Semantic tone color palette for the KPI support row. |
...
| `format` | str \| [FormatConfig](#formatconfig) \| enum: "compact", "currency", "currency_compact", "currency_whole", "date_short", "delta", "integer", "number", "number_default", "percent", "percent_delta", "percent_whole", "year" | ✓ | D3 format string or format config object. Optional; inherits the chart measure format when omitted and source matches chart.y. |
...
| `format` | str \| [FormatConfig](#formatconfig) \| enum: "compact", "currency", "currency_compact", "currency_whole", "date_short", "delta", "integer", "number", "number_default", "percent", "percent_delta", "percent_whole", "year" | ✓ | D3 format string or format config object for the aggregated value. Optional. |
...
| `format` | str \| [FormatConfig](#formatconfig) \| enum: "compact", "currency", "currency_compact", "currency_whole", "date_short", "delta", "integer", "number", "number_default", "percent", "percent_delta", "percent_whole", "year" | ✓ | D3 format string or format config object. Optional. |
...
| `categorical` | [CategoricalColorStyle](#categoricalcolorstyle) | ✓ | Categorical color and single-series palette config. |
...
| Field | Type | Optional | Description |
|-------|------|:--------:|-------------|
| `font` | [FontStyle](#fontstyle) | ✓ | Data_table font style overrides. Unset fields fall back to [`style.charts.font`](#chartsstyle). |
...
| `scale` | [LayerAxisYScale](#layeraxisyscale) | ✓ | Scale overrides for this layer's y axis. |
| `ticks` | [LayerAxisYTicks](#layeraxisyticks) | ✓ | Tick overrides for this layer's y axis. |
| `grid` | [LayerAxisYGrid](#layeraxisygrid) | ✓ | Grid overrides for this layer's y axis. |
| `label` | [LayerAxisYLabel](#layeraxisylabel) | ✓ | Label format override for this layer's y axis. |
...
| Field | Type | Optional | Description |
|-------|------|:--------:|-------------|
| `font` | [FontStyle](#fontstyle) | ✓ | KPI value font style. Unset fields fall back to [`style.charts.kpi.font`](#kpichartstyle). |
| `format` | str \| [FormatConfig](#formatconfig) \| enum: "compact", "currency", "currency_compact", "currency_whole", "date_short", "delta", "integer", "number", "number_default", "percent", "percent_delta", "percent_whole", "year" | ✓ | Number format for the KPI headline value: D3 format string, preset name, or FormatConfig object. |
...
| Field | Type | Optional | Description |
|-------|------|:--------:|-------------|
| `font` | [FontStyle](#fontstyle) | ✓ | Slot font style. Unset fields fall back to [`style.charts.kpi.font`](#kpichartstyle). |
...
| `format` | str \| [FormatConfig](#formatconfig) \| enum: "compact", "currency", "currency_compact", "currency_whole", "date_short", "delta", "integer", "number", "number_default", "percent", "percent_delta", "percent_whole", "year" | ✓ | Override cell value format (D3 format string or format config object). |
...
| `format` | str \| [FormatConfig](#formatconfig) \| enum: "compact", "currency", "currency_compact", "currency_whole", "date_short", "delta", "integer", "number", "number_default", "percent", "percent_delta", "percent_whole", "year" | ✓ | Number format (D3 string, preset name, or FormatConfig). |
| `spark` | [SparkConfig](#sparkconfig) \| enum: "line", "area", "bar", "bar-normalize", "column", "columns" | ✓ | Inline spark chart config or spark type name. |
...
| Field | Type | Optional | Description |
|-------|------|:--------:|-------------|
| `font` | [FontStyle](#fontstyle) | ✓ | Row label font style overrides. Unset fields fall back to [`style.charts.data_table.font`](#datatablestyle). |
